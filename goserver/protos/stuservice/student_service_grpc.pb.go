...
type StuserviceClient interface {
	...
	QueryByID(ctx context.Context, in *wrapperspb.Int64Value, opts ...grpc.CallOption) (*wrapperspb.StringValue, error)
...
func (c *stuserviceClient) QueryByID(ctx context.Context, in *wrapperspb.Int64Value, opts ...grpc.CallOption) (*wrapperspb.StringValue, error) {
...
type StuserviceServer interface {
	...
	// Student queryByID(int stuID)
	QueryByID(context.Context, *wrapperspb.Int64Value) (*wrapperspb.StringValue, error)
	// Students queryByName(String name)
...
func (UnimplementedStuserviceServer) QueryByID(context.Context, *wrapperspb.Int64Value) (*wrapperspb.StringValue, error) {
